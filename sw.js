const SITEWORKS_SW_VERSION = "20260924-logbook-notify-directory-49";
const STATIC_CACHE = `siteworks-static-${SITEWORKS_SW_VERSION}`;

const STATIC_ASSETS = [
  "/styles.css?v=20260924-logbook-notify-directory-49",
  ...
  "/app.js?v=20260924-logbook-notify-directory-49",
