const SITEWORKS_SW_VERSION = "20260924-contractor-inventory-tab-42";
const STATIC_CACHE = `siteworks-static-${SITEWORKS_SW_VERSION}`;

const STATIC_ASSETS = [
  "/styles.css?v=20260924-contractor-inventory-tab-42",
  ...
  "/app.js?v=20260924-contractor-inventory-tab-42",
