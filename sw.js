const SITEWORKS_SW_VERSION = "20260817-site-map-monitor-01";
const STATIC_CACHE = `siteworks-static-${SITEWORKS_SW_VERSION}`;

const STATIC_ASSETS = [
  "/styles.css?v=20260817-site-map-monitor-01",
  "/keybox.css?v=20260809-key-search-25",
  "/keybox.js?v=20260809-key-wizard-22",
  "/monitoring-engine.js?v=20260805-monitoring-engine",
  "/app.js?v=20260817-site-map-monitor-01",
  "/manifest.webmanifest?v=20260817-site-map-monitor-01",
  "/icons/siteworks-icon-192.png?v=20260817-site-map-monitor-01",
  "/icons/siteworks-icon-512.png?v=20260817-site-map-monitor-01"
];
